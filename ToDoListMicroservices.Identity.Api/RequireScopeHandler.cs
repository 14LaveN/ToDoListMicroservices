...
namespace ToDoListMicroservices.Identity.Api;
...
public sealed class RequireScopeHandler : AuthorizationHandler<ScopeRequirement>
{
    ...
    /// <returns></returns>
    protected override System.Threading.Tasks.Task HandleRequirementAsync(AuthorizationHandlerContext context, ScopeRequirement requirement)
    {
        var scopeClaim = context.User.FindFirst(c => c.Issuer == requirement.Issuer);
